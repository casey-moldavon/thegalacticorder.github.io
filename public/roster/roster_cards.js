...
async function generateCardData() {
    ...
    var novitiateCards = novitiates.map(
        row =>
        `
        <div id="novitiate_card" type="button" class="card text-center" data-bs-toggle="collapse" data-bs-target="#unit_id_${row.sc_name}" aria-expanded="false" aria-controls="unit_id_${row.sc_name}" style="width: 9rem;">
            <div>
        ...
        <div class="collapse fixed-top" id="unit_id_${row.sc_name}">
            <div class="container container-fluid" id="novitiate_unit_id_container">
                ...
                <div id="novitiate_data_container" class="container container-fluid">
    ...
    var ensignTrooperCards = ensignTroopers.map(
        row =>
        `
        <div id="combat_card" type="button" class="card text-center" data-bs-toggle="collapse" data-bs-target="#unit_id_${row.sc_name}" aria-expanded="false" aria-controls="unit_id_${row.sc_name}" style="width: 9rem;">
            <div>
        ...
        <div class="collapse fixed-top" id="unit_id_${row.sc_name}">
            <div class="container container-fluid" id="combat_unit_id_container">
                ...
                <div id="combat_data_container" class="container container-fluid">
                    <div id="unit_data_container" class="container">
                        <div class="row">
    ...
    var ensignOperatorCards = ensignOperators.map(
        row =>
        `
        <div id="engineer_card" type="button" class="card text-center" data-bs-toggle="collapse" data-bs-target="#unit_id_${row.sc_name}" aria-expanded="false" aria-controls="unit_id_${row.sc_name}" style="width: 9rem;">
            <div>
        ...
        <div class="collapse fixed-top" id="unit_id_${row.sc_name}">
            <div class="container container-fluid" id="engineer_unit_id_container">
                ...
                <div id="engineer_data_container" class="container container-fluid">
                    <div id="unit_data_container" class="container">
                        <div class="row">
    ...
    var ensignMedicCards = ensignMedics.map(
        row =>
        `
        <div id="medical_card" type="button" class="card text-center" data-bs-toggle="collapse" data-bs-target="#unit_id_${row.sc_name}" aria-expanded="false" aria-controls="unit_id_${row.sc_name}" style="width: 9rem;">
        <div>
    ...
    <div class="collapse fixed-top" id="unit_id_${row.sc_name}">
        <div class="container container-fluid" id="medical_unit_id_container">
            ...
            <div id="medical_data_container" class="container container-fluid">
                <div id="unit_data_container" class="container">
                    <div class="row">
    ...
    var fieldResearcherCards = fieldResearchers.map(
        row =>
        `
        <div id="science_card" type="button" class="card text-center" data-bs-toggle="collapse" data-bs-target="#unit_id_${row.sc_name}" aria-expanded="false" aria-controls="unit_id_${row.sc_name}" style="width: 9rem;">
            <div>
        ...
        <div class="collapse fixed-top" id="unit_id_${row.sc_name}">
            <div class="container container-fluid" id="science_unit_id_container">
                ...
                <div id="science_data_container" class="container container-fluid">
                    <div id="unit_data_container" class="container">
                        <div class="row">
